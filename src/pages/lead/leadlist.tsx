...
import { Table, Button, Modal, Input, Layout, Breadcrumb, theme, Menu, notification, Empty } from 'antd';
...
const LeadSourceList: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="lead-source-container p-6 bg-gray-100 min-h-screen">
        <div className="bg-white p-4 rounded shadow-md">
          <h2 className="text-red-500">Lỗi: {error.message || 'Không thể tải dữ liệu'}</h2>
        </div>
      </div>
    );
  }
  ...
  return (
    <Layout>
      ...
      <Content style={{ padding: '0 48px' }}>
        ...
        >
          <div className="lead-source-container p-6 bg-gray-100 max-h-screen">
