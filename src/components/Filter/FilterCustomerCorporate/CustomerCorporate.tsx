...
const CustomerCorporate: React.FC<Props> = ({ onFilter, onClear, initialValues }) => {
  ...
  return (
    <div className="Filter-menu">
      <Form layout="vertical" form={form} onFinish={handleFinish} initialValues={initialValues}>
        <div className="Filter-menu-Corporate">
          <Form.Item name="status" label="Người tạo">
            <Select placeholder="Chọn nhân viên"></Select>
          </Form.Item>
